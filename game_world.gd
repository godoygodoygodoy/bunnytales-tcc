...
var fallen_wood_tex  = preload("res://fallen_wood.png")
var grass_tex        = preload("res://grass.png")
var grass1_tex       = preload("res://grass1.png")
...
func _init_systems() -> void:
	_ability_system = load("res://AbilitySystem.gd").new()
	_xp_system = load("res://XPSystem.gd").new()
	_shop_system = load("res://ShopSystem.gd").new()
	_level_manager = load("res://LevelManager.gd").new()
	_ending_manager = load("res://EndingManager.gd").new()
	_enemy_spawner = load("res://EnemySpawner.gd").new()
...
func _create_checkpoints() -> void:
	for i in range(CHECKPOINT_XS.size()):
		var cp: Area2D = load("res://Checkpoint.gd").new()
